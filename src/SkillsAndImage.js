...
function SkillsAndImages() {
    const [selectedImage, setSelectedImage] = useState('https://www.cynohub.com/wp-content/uploads/2023/01/imgpsh_fullsize_anim.gif');
    const [clickedText, setClickedText] = useState(null);
    const [selectedImage1, setSelectedImage1] = useState('https://www.cynohub.com/wp-content/uploads/2022/12/1-2.png');
